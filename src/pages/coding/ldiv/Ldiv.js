...
// })
    ...
    return (
        <Card className='ldiv bg-t'>
            ...
            <div className="row my-2 QuestionBox2">

{/* <Card className='qdisp bg-t b-2'>
<textarea name="" className='qdispt bg-t c-w 'id="qdispt" readOnly>{qdisp}</textarea>
</Card> */}
        <Card className="myQuestionCard2">
            <Card.Body className=' my-auto centerit'>
                <Card.Text className="row d-flex flex-row justify-content-center">
            {/* <Card className="col-md-6 inp bg-t b-2">
                <div className='bg-b'><h5>Custom Input</h5></div>
                <textarea name="" id="" className='inpt bg-t c-w br-2'></textarea>
            </Card> */}
            <Card className="col-10 col-sm-9 col-sx-4 col-md-4 col-lg-4 bg-t b-2 border-0 ">
            ...
            <Card className="col-2 col-sm-3 col-sx-2 col-md-2 col-lg-2 bg-t b-2 border-0 d-flex justify-content-center align-items-center">
              <button className="rbnRun bg-t  b-1 c-w br-2 pd-lr-15 b-2 " onClick={findOutput}><span><i class="fa-solid fa-play"></i> </span>Run</button>
            </Card>
